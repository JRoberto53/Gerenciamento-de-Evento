        ...
        <td width="48%" height="20" nowrap="nowrap">&nbsp;</td>
		  ...
		  <table width="100%" border="0" cellspacing="4" cellpadding="0">
		    ...
		    <tr>
              ...
              <td align="left" valign="middle" class="menu002d"><?php echo formataTelefone($usu_celular); ?>&nbsp;<?php if ($usu_whatsapp == 'checked'){ echo '<img src="/pi_facu/images/whatsapp.png" width="20" height="20" alt=""/>'; }  ?>               
            </tr>
		    <tr>
