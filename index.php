...
<title>PI - Grupo 23</title>
<link href="css/estilo.css" rel="stylesheet" type="text/css" />

</head>

<body>
<div id="logo"><img src="images/logo_2.png" alt="" width="299%" id="img_logo" border="0"/></div>
...
<div class="div_login" >
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody>
      <tr>
        <td colspan="2" align="center" valign="middle" nowrap="nowrap" class="menu002a">Seja Bem-vindo</td>
      </tr>
      <tr>
        <td colspan="2" align="center" valign="middle" nowrap="nowrap"><div id="div_ft" class="div_foto"><img src="images/foto_usu.png" alt="" width="100%" id="usu_foto" border="0"/></div></td>
      </tr>
      <tr>
